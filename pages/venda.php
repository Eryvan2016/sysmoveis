                                        ...
                                        <table class="table table-striped table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($lista as $produto) {
                                                    ...
                                                    echo "<td><button  class ='btn btn-success btn-circle' onclick='adicionarNoCarrinho(\"" . $produto->getNome() . "\",\"" . $produto->getDescricao() . "\"," . $produto->getValor() . "\"," . $produto->getQuantidade().")'><i class='fa fa-cart-plus'></i></button></td>";
                                                    echo "</tr>";
                                                }
                                                ?>
