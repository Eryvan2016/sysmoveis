                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Cadastre seu cliente aqui!!
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <form role="form" action="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/sysmoveis/controle/controleCliente.php'?>" method="post" > <!-- falta informar o destino do formulario e o método-->
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Digite o cpf..." id="cpf" name="cpf">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Digite o ponto de referência..." id="PontoReferencia" name="PontoReferencia">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
